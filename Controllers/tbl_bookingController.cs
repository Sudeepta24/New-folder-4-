...
namespace HotelManagmentSystem.Controllers
{
    public class tbl_bookingController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "booking_id,customer_name,customer_address,customer_email,customer_phone_no,booking_from,booking_to,payment_type,assigned_room,no_of_members,total_amount,payment_date")] tbl_booking tbl_booking)
        {
