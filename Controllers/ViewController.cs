...
namespace HotelManagmentSystem.Controllers
{
    ...
    {
        public HMSDBEntities db = new HMSDBEntities();
        ...
        public ActionResult Home([Bind(Include = "booking_id,customer_name,customer_address,customer_email,customer_phone_no,booking_from,booking_to,payment_type,assigned_room,no_of_members,total_amount,payment_type")]tbl_booking tbl_booking)
        {
            ...
            tbl_booking roombooking = new tbl_booking()
            {
                ...
                no_of_members = tbl_booking.no_of_members,
                 payment_date = tbl_booking.payment_date,
        ...
        [HttpPost]
        public ActionResult Room([Bind(Include = "booking_id,customer_name,customer_address,customer_email,customer_phone_no,booking_from,booking_to,payment_type,assigned_room,no_of_members,total_amount,payment_date")]tbl_booking tbl_booking)
        {
            int numberofday = Convert.ToInt32((tbl_booking.booking_to - tbl_booking.booking_from).TotalDays);
        ...
        [HttpPost]
        public ActionResult About([Bind(Include = "booking_id,customer_name,customer_address,customer_email,customer_phone_no,booking_from,booking_to,payment_type,assigned_room,no_of_members,total_amount,payment_date")]tbl_booking tbl_booking)
        {
            int numberofday = Convert.ToInt32((tbl_booking.booking_to - tbl_booking.booking_from).TotalDays);
        ...
        [HttpPost]
        public ActionResult Contact([Bind(Include = "booking_id,customer_name,customer_address,customer_email,customer_phone_no,booking_from,booking_to,payment_type,assigned_room,no_of_members,total_amount,payment_date")]tbl_booking tbl_booking)
        {
            int numberofday = Convert.ToInt32((tbl_booking.booking_to - tbl_booking.booking_from).TotalDays);
